...
/*    */ 
/*    */ 
/*    */ public class TeacContactController
...
/* 41 */       TeachingStaff.getContacts().setConName(this.conName.getText());
/* 42 */       TeachingStaff.getContacts().setConDeatails(this.conNum.getText());
/* 43 */       TeachingStaff.getDialogStage2().close();
/*    */     } else {
...
/* Location:              C:\Users\Abdo\Documents\Amgad-H.jar!\Controller\TeacContactController.class
