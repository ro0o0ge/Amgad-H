...
/*      */               break;
/*      */             case 77:
/*  289 */               this.Optional_S_2.setText(String.valueOf(a.getGrade())); break;
/*      */           }  continue;
/*      */         } 
...
/*      */               break;
/*      */             case 117:
/*  382 */               this.Optional_S_2.setText(String.valueOf(a.getGrade())); break;
/*      */           }  continue;
/*      */         } 
...
/*  622 */         if (y >= 85.0D)
/*  623 */           return "م"; 
/*  624 */         if (y < 85.0D && y >= 75.0D)
/*  625 */           return "ج ج"; 
/*  626 */         if (y < 75.0D && y >= 65.0D)
/*  627 */           return "ج"; 
...
/*  634 */         if (y >= 68.0D)
/*  635 */           return "م"; 
/*  636 */         if (y < 68.0D && y >= 60.0D)
/*  637 */           return "ج ج"; 
/*  638 */         if (y < 60.0D && y >= 52.0D)
/*  639 */           return "ج"; 
...
/*  646 */         if (y >= 25.5D)
/*  647 */           return "م"; 
/*  648 */         if (y < 25.5D && y >= 22.5D)
/*  649 */           return "ج ج"; 
/*  650 */         if (y < 22.5D && y >= 19.5D)
/*  651 */           return "ج"; 
...
/*  658 */         if (y >= 17.0D)
/*  659 */           return "م"; 
/*  660 */         if (y < 17.0D && y >= 15.0D)
/*  661 */           return "ج ج"; 
/*  662 */         if (y < 15.0D && y >= 13.0D)
/*  663 */           return "ج"; 
...
/*  670 */         if (y >= 297.5D)
/*  671 */           return "م"; 
/*  672 */         if (y < 297.5D && y >= 262.5D)
/*  673 */           return "ج ج"; 
/*  674 */         if (y < 262.5D && y >= 227.5D)
/*  675 */           return "ج"; 
...
/*  845 */         Double.valueOf(this.French_S_1.getText()).doubleValue() <= 75.0D) {
...
/*  853 */         Double.valueOf(this.French_S_2.getText()).doubleValue() <= 25.0D) {
