...
public class EditStudController
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        /*  75 */ this.ComboSearch.getSelectionModel().select(0);
    ...
    public void Search() {
        /* 100 */ if (!this.SearchQuery.getText().equals("")) {
            ...
            System.out.println(ComboSearchClass.getSelectionModel().getSelectedItem().toString());
             if (this.ComboSearch.getSelectionModel().isSelected(0)) {
                 Integer year=null;
