 ...
 * @author Abdo
 */
public class Absent_EmpController implements Initializable {
...
//        ComboTimeType.getSelectionModel().select(1);
        ...
        StudentsTable.setItems(Management.getPersonsList());
    ...
    public void Search() {
        if (!SearchQuery.getText().equals("")) {
            ObservableList<Staff> TempList = FXCollections.observableArrayList(MA.getActiveTeachers());
            StudentsTable.getItems().clear();
